...
// Load projects from JSON file or localStorage
async function loadProjects() {
    try {
        // Try to load from JSON file first (for backend mode)
        ...
        console.log('Loading from localStorage due to fetch error:', error);
        const stored = localStorage.getItem('portfolio_projects');
        if (stored) {
            projects = JSON.parse(stored);
        }
